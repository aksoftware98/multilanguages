...
namespace AKSoftware.Localization.MultiLanguages.Tasks
{
    ...
    public class SampleTask : Task
    {
        ...
        {
            Log.LogWarning("This task is deprecated and will be removed in the next version. Please use the new AKSoftware.Localization.MultiLanguages.Generator package instead.");
            Log.LogMessage(MessageImportance.High, "Hello World!");
            return true;
        }
    }

    public class LanguageKeysGenerator : Task
    {
        //The name of the class which is going to be generated
        [Required]
        public string KeysClassName { get; set; }

        //The name of the namespace where the class is going to be generated
        [Required]
        public string KeysNamespaceName { get; set; }

        //List of files which we need to read with the defined format: 'propertyName:type:defaultValue' per line
        [Required]
        public ITaskItem[] LanguageFiles { get; set; }
