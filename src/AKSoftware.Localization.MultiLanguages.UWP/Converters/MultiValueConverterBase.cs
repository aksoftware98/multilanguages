...
{
    /// <summary>
    /// An <see cref="IValueConverter"/> abstract implementation to be used with the <see cref="AKSoftware.Localization.MultiLanguages.UWP.Behaviors.MultiBindingBehavior"/>.
    /// </summary>
